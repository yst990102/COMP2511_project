...
public class LoopManiaApplication extends Application {
    ...
    public void start(Stage primaryStage) throws IOException {
        ...
        mainMenuController.setGameSavedSwitcher(() -> {switchToRoot(scene, gamesavedRoot, primaryStage);});
        ...
        gamesavedController.setMainMenuSwitcher(() -> {switchToRoot(scene, mainMenuRoot, primaryStage);});
